...
extension ClientProxyMock {
    convenience init(_ configuration: ClientProxyMockConfiguration) {
        ...
        createRoomAccessRulesNameTopicIsRoomPrivateIsRoomEncryptedIsKnockingOnlyUserIDsAvatarURLAliasLocalPartReturnValue = .failure(.sdkError(ClientProxyMockError.generic)) // Tchap: handle additional `isEncrypted` property
